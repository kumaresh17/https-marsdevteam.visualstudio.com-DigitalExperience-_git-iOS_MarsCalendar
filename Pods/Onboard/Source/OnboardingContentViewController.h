 ...
 */
+ (nonnull instancetype)contentWithTitle:(nullable NSString *)title body:(nullable NSString *)body image:(nullable UIImage *)image imageFrame:(CGRect)frame buttonText:(nullable NSString *)buttonText action:(nullable dispatch_block_t)action;
 ...
 * @return An instance of OnboardingViewController with the provided information.
 */
- (nonnull instancetype)initWithTitle:(nullable NSString *)title body:(nullable NSString *)body image:(nullable UIImage *)image imageFrame:(CGRect)frame buttonText:(nullable NSString *)buttonText action:(nullable dispatch_block_t)action;
 ...
 * @return An instance of OnboardingViewController with the provided information.
 */
+ (nonnull instancetype)contentWithTitle:(nullable NSString *)title body:(nullable NSString *)body image:(nullable UIImage *)image imageFrame:(CGRect)frame buttonText:(nullable NSString *)buttonText actionBlock:(nullable action_callback)actionBlock;
//Custom
 ...
 * @return An instance of OnboardingViewController with the provided information.
 */
- (nonnull instancetype)initWithTitle:(nullable NSString *)title body:(nullable NSString *)body image:(nullable UIImage *)image imageFrame:(CGRect)frame buttonText:(nullable NSString *)buttonText actionBlock:(nullable action_callback)actionBlock;
 ...
 * @return An instance of OnboardingViewController with the provided information.
 */
- (nonnull instancetype)initWithTitle:(nullable NSString *)title body:(nullable NSString *)body image:(nullable UIImage *)image imageFrame:(CGRect)frame videoURL:(nullable NSURL *)videoURL buttonText:(nullable NSString *)buttonText actionBlock:(nullable action_callback)actionBlock;
