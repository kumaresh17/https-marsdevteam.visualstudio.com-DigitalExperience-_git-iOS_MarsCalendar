...
+ (instancetype)contentWithTitle:(NSString *)title body:(NSString *)body image:(UIImage *)image imageFrame:(CGRect)frame buttonText:(NSString *)buttonText action:(dispatch_block_t)action {
    return [[self alloc] initWithTitle:title body:body image:image imageFrame:frame buttonText:buttonText action:action];
}

- (instancetype)initWithTitle:(NSString *)title body:(NSString *)body image:(UIImage *)image imageFrame:(CGRect)frame buttonText:(NSString *)buttonText action:(dispatch_block_t)action {
    return [self initWithTitle:title body:body image:image imageFrame:frame buttonText:buttonText actionBlock:^(OnboardingViewController *onboardController) {
        if (action) {
            action();
        }
    }];
...
+ (instancetype)contentWithTitle:(NSString *)title body:(NSString *)body image:(UIImage *)image imageFrame:(CGRect)frame buttonText:(NSString *)buttonText actionBlock:(action_callback)actionBlock {
    return [[self alloc] initWithTitle:title body:body image:image imageFrame:frame buttonText:buttonText actionBlock:actionBlock];
}
...
- (instancetype)initWithTitle:(NSString *)title body:(NSString *)body videoURL:(NSURL *)videoURL  buttonText:(NSString *)buttonText action:(dispatch_block_t)action {
    return [self initWithTitle:title body:body image:nil imageFrame:CGRectMake(0, 0, 0, 0) videoURL:videoURL buttonText:buttonText actionBlock:^(OnboardingViewController *onboardController) {
        if (action) {
            action();
        }
    }];
...
+ (instancetype)contentWithTitle:(NSString *)title body:(NSString *)body videoURL:(NSURL *)videoURL  buttonText:(NSString *)buttonText actionBlock:(action_callback)actionBlock {
    return [[self alloc] initWithTitle:title body:body image:nil imageFrame:CGRectMake(0, 0, 0, 0) videoURL:videoURL buttonText:buttonText actionBlock:actionBlock];
}
//Custom
- (instancetype)initWithTitle:(NSString *)title body:(NSString *)body image:(UIImage *)image imageFrame:(CGRect)frame buttonText:(NSString *)buttonText actionBlock:(action_callback)actionBlock {
    return [self initWithTitle:title body:body image:image imageFrame:frame videoURL:nil buttonText:buttonText actionBlock:actionBlock];
}
//Custom
- (instancetype)initWithTitle:(NSString *)title body:(NSString *)body image:(UIImage *)image imageFrame:(CGRect)frame videoURL:(NSURL *)videoURL buttonText:(NSString *)buttonText actionBlock:(action_callback)actionBlock {
    self = [super init];
