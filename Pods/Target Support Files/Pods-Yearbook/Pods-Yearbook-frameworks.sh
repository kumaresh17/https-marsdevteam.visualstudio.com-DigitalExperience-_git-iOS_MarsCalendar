...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/LTHMonthYearPickerView/LTHMonthYearPickerView.framework"
  install_framework "$BUILT_PRODUCTS_DIR/NSDate+timezones/NSDate_timezones.framework"
