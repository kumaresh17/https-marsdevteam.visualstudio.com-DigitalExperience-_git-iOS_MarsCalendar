...
- (void)layoutSubviews
{
    ...
    //Updated the Selection Layer Diameter to 35% of height of the Calendar Cell
    CGFloat diameter = MIN(self.bounds.size.height*self.preferredBorderWidthPercentage,self.bounds.size.width);
